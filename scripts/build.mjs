...
const robotics=JSON.parse(await fs.readFile(path.join(root,'data/robotics-security.json'),'utf8'));
robotics.archive=JSON.parse(await fs.readFile(path.join(root,'data/robotics-conferences.json'),'utf8'));
