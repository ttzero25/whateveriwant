...
LLM은 비정형 위협 보고서를 요약하고 지표·TTP를 추출하는 데 유용하지만, 환각으로 없는 지표를 만들거나 신뢰도를 부풀릴 수 있습니다. 추출 결과는 출처에 대조해 검증하고, 자동 차단에 바로 연결하지 않습니다. [LLM 프롬프트 인젝션 방어](../security-for-ai/llm-prompt-injection.md)
