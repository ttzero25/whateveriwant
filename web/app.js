...
function library(){
 ...
 if(!activeTopic()){renderDailyUpdates(document.querySelector('#home-today'),lang);renderHomeUpdates(document.querySelector('#home-updates'),lang,documents);}
}
