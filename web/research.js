...
async function renderResearch(main,lang){
 ...
 try{
  ...
  if(config.setupArchive)config.setupArchive(main.querySelector('#conference-watch'),data.archive,lang);
  else setupConferences(main.querySelector('#conference-watch'),data.conferences,lang);
  let visible=24;
...
export const {loadResearch,renderResearch}=createResearchWatch();
